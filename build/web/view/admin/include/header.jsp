                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="#" style="font-size: 18px"><i class="fa fa-group fa-fw"></i> Manage Counselor <span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="<%=getServletContext().getContextPath()%>/view/addCounselor.jsp">Add Counselor</a>
                                    </li>
                                    <li>
                                        <a href="<%=getServletContext().getContextPath()%>/listCounsellors.html">List Counselors </a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
