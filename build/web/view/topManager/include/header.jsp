                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            <li>
                                <a href="<%=getServletContext().getContextPath()%>/activeLeadReport.html" style="font-size: 18px">Active Lead Reports <span class="fa arrow"></span></a>
                            </li>
                            <li>
                                <a href="<%=getServletContext().getContextPath()%>/counselorReport.html" style="font-size: 18px">Counselor Report <span class="fa arrow"></span></a>
                            </li>
                            <li>

                                <a href="<%=getServletContext().getContextPath()%>/view/statusReport.jsp" style="font-size: 18px">Status Reports <span class="fa arrow"></span></a>
                            </li>
                            <li>
                                <a href="<%=getServletContext().getContextPath()%>/" style="font-size: 18px"><i class="fa fa-hospital-o fa-fw"></i> Customized Reports <span class="fa arrow"></span></a>
                                <ul class="nav dropdown-menu">
                                    <li>
                                        <a href="view/dwReportFilterForm.jsp"> Date-wise Leads Report </a>
                                    </li>
                                    <li>
                                        <a href="<%=getServletContext().getContextPath()%>/swreport-fill">Semester-wise Leads Report </a>
                                    </li>
                                    <li>
                                        <a href="<%=getServletContext().getContextPath()%>/cwreport-fill">Counselor-wise Leads Report </a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
